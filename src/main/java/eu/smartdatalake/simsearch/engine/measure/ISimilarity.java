...
public interface ISimilarity<V> {
	...
	/**
	 * Sets the scale factor to the given value.
	 * @param scale  A double value representing the scale factor to apply on distances before issuing similarity scores.
	 * @return  True, if the scale factor has been set and it is above 0; otherwise, False.
	 */
	public boolean setScaleFactor(double scale);
