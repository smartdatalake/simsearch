...
public class DictionaryReader<K,V> {
	 ...
	 */
	public HashMap<K, V> readFromJDBCTable(String tableName, String keyColumnName, String valColumnName, JdbcConnector jdbcConnector, Logger log) {
...
//			 System.out.println("STRING VALUE query: " + sql);
	 ...
	 * @return  A dictionary (i.e., a hash map) of the (key,value) pairs.
	 */
	public HashMap<K, V> readFromCSVFile(String inputFile, int maxLines, int colKey, int colValue, String columnDelimiter, boolean header, Logger log) {
