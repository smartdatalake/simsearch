...
import eu.smartdatalake.simsearch.pivoting.rtree.internal.util.Pair;
...
//        final List<T> group2 = Lists.newArrayList(worstCombination.value2());
        final List<T> group1 = new ArrayList<T>();
        group1.add(worstCombination.value1());
        final List<T> group2 = new ArrayList<T>();
        group2.add(worstCombination.value2());
