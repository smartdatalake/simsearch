...
/**
 * Implements calculation of Euclidean distance between two multi-dimensional points.
 ...
 */
public class EuclideanDistance<V> implements IDistance<V> {
	...
	@Override
	// Measure the absolute difference between two Euclidean distances
	...
	/**
	 * Calculates the Euclidean distance between two equi-sized arrays of double values.
	 ...
	 * @return  A double value measuring the Euclidean distance between the two arrays.
	 */
     ...
     * @return  A double value measuring the Euclidean distance between the two points.
     */
